...
winner_label = Label(text = "Let's Start the Game...", fg = 'dark blue', font = font.Font(size = 13), pady = 8)
winner_label.pack()
...
rock_btn = Button(input_frame, text = 'Rock', width = 15, bd = 0, bg = 'orange', pady = 5, command = lambda: player_choice(options[0]))
...
#Now you can see the result and play the game 